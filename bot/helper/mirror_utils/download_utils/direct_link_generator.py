...
def direct_link_generator(link: str):
    ...
    elif any(x in domain for x in ['terabox', 'nephobox', '4funbox', 'mirrobox', 'momerybox', 'teraboxapp', 'www.teraboxapp.com', 'teraboxapp.com', '1024tera.com', 'www.1024tera.com', '1024tera']):
        return terabox(link)
